...
import firebase from 'firebase/compat/app'; // Import Firebase from compat namespace
import 'firebase/compat/firestore'; // Import specific modules from compat namespace
